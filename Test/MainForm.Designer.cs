namespace Test
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.леваяРукаToolStripMenuItem.Click += new System.EventHandler(this.GreenButton);
			// 
			...
			this.праваяРукаToolStripMenuItem.Click += new System.EventHandler(this.GreenButton);
			// 
			// MainForm
			// 
